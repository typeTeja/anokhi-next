  ...
  return (
    <section className="relative py-24 w-full text-white text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 space-y-6">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-heading font-black uppercase leading-tight">
        ...
        <Link href="/contact">
          <Button className="bg-black hover:bg-white/90 text-white px-10 py-5 rounded-2xl text-sm font-bold uppercase tracking-widest transition-all shadow-2xl shadow-black/40 hover:scale-[1.05] active:scale-95 h-auto hover:text-black">
            Book Now
          </Button>
        </Link>
      </div>
